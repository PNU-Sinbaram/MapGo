...
class Post(models.Model):
    ...
    writer = models.ForeignKey(User, related_name="writer", on_delete=models.CASCADE, db_column='author_id')
...
class Comment(models.Model):
    writer = models.ForeignKey(User, related_name="comment", on_delete=models.CASCADE, db_column='author_comment_id')
